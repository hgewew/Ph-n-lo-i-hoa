...
Scikit-learn: thư viện học máy để huấn luyện và sử dụng mô hình KNN.
Pandas: xử lý và đọc dữ liệu từ file CSV.
2. Thuật toán
K-Nearest Neighbors (KNN):
Dựa vào khoảng cách (Euclidean distance) giữa điểm cần dự đoán và các điểm trong tập huấn luyện.
Tìm k láng giềng gần nhất, sau đó gán nhãn theo số đông.
Ở đây chọn k = 5.
3. Ngôn ngữ lập trình
Python: để lập trình xử lý dữ liệu, huấn luyện mô hình, và xây dựng web với Flask.
HTML/CSS: để tạo giao diện người dùng.
<img width="509" height="555" alt="image" src="https://github.com/user-attachments/assets/c71fe050-4c46-42e3-9eeb-f85cde836ef1" />
